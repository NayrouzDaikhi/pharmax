 ...
 */
final class Version20260209155001 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, titre, contenu, image, date_creation, date_modification, likes FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, contenu CLOB NOT NULL, image VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME DEFAULT NULL, likes INTEGER DEFAULT 0 NOT NULL, slug VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO article (id, titre, contenu, image, date_creation, date_modification, likes) SELECT id, titre, contenu, image, date_creation, date_modification, likes FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
    }
}
